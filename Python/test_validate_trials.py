...
if __name__ == '__main__':
    ...
    data = pd.read_csv('/home/adrian/SingleCP_DotsReversal/raw/2019_07_10_17_42/2019_07_10_17_42customFIRA.csv')
    data = data.drop(['taskID', 'startResponseTwo', 'targetOff', 'fixationOff', 'feedbackOn', 'CPresponseSide', 'dirReleaseChoiceTime', 'cpChoiceTime',
            'dirChoiceTime', 'targetOn', 'fixationStart', 'fixationOn', 'randSeedBase', 'timeCP', 'coherence',
            'presenceCP', 'trialEnd', 'trialStart'], axis=1)
    data = data.iloc[:5]
