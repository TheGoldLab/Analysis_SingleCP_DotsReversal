...
Accuracy on 0-coherence no-CP trials, per subject
```{r}
...
subj <- c("S5", "S1", "S2", "S5", "S4", "S3", "S2", "S1", "S1", "S1")
num_cases <- length(subj)
probcp <- rep_len(0, num_cases)
coh <- c(62, 100, 22.0, 0,0,0,100, 0, 0, 0)
vd <- c(100, 100, 100, 100, 200, 200, 200, 200, 300, 400)
